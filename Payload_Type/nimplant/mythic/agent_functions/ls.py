...
class LsArguments(TaskArguments):
    ...
    def __init__(self, command_line, **kwargs):
        ...
        self.args = [
            ...
            CommandParameter(
                name="recurse",
                cli_name="Recurse",
                display_name="Recurse into directory.",
                type=ParameterType.String,
                description="recurse into directory.",
                default_value="false",
                parameter_group_info=[
                    ParameterGroupInfo(
                        required=False,
    ...
    async def parse_arguments(self):
        ...
        if self.get_arg("recurse") is None:
            self.add_arg("recurse", "false")
        if self.get_arg("file_browser") is None:
            self.add_arg("file_browser", "file_browser")  
